      ...
      <div class="form-container">
        ...
        <form class="form-content" method="POST" autocomplete="off">
          <div>
            ...
            <input name="name" value="<?=$item['name']?>" type="text" class="form-control" placeholder="Name..."
              required>
          </div>
          <div>
            <div class="left-form product-price">Đơn giá</div>
            <input name="price" value="<?=$item['price']?>" type="text" class="form-control" placeholder="Price..."
              required>
          </div>
          <div>
            <div class="left-form product-image">Hình ảnh</div>
            <input name="image" value="<?=$item['image']?>" type="text" class="form-control"
              placeholder="Link Image...">
          </div>

          <div>
            <div class="left-form product-description">Mô tả sản phẩm</div>
            <input name="description" value="<?=$item['description']?>" type="text" class="form-control"
