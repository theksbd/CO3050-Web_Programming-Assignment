		...
		<form method="POST" action="cart.php?action=submit" autocomplete="off">
				...
				if(!empty($data)){
					...
					foreach($data as $item){
						...
						<div class="cart-body">
							...
							<div class="cart-price a-center" style="width: 17%">'. $item['price'] .' VND</div>
							...
							<div class="cart-totalperItem a-center" style="width: 14%">'. $item['price'] * $_SESSION["cart"][$item['id']] .' VND</div>
			...
			<div class="total">
				...
				<div class="confirm-cart">
					<span style="font-size: 24px">Tổng tiền thanh toán:</span><p style="font-size: 40px; color: #FFAC4B"><?=$totalMoney?> VND</p>
